...
for(let s=start; s<=end; s++){
  ...
  if (s%5===0){ const mm=String(Math.floor(s/60)).padStart(2,'0'); const ss=String(s%60).padStart(2,'0'); ctx.fillText(`${mm}:${ss}`, x, h-4); }
}
}
